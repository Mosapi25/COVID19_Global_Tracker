...
Load data using pandas.read\_csv().
...
date, location, total\_cases, total\_deaths, new\_cases, new\_deaths, total\_vaccinations, etc.
...
Convert date column to datetime: pd.to\_datetime().
...
Calculate the death rate: total\_deaths / total\_cases.
...
Prepare a dataframe with iso\_code, total\_cases for the latest date.
